%  DEMOOPTICS03 - Image of dipoles, optical axis -z.
...
%  imaging lens, image dipoles from below
NA = 0.8;
lens = optics.lensimage( mat, air, k0, NA, 'rot', optics.roty( 180 ) );
dir = lens.dir;
...
for iz = 1 : numel( zf )
  ...
  %  plot image of dipoles, flip x-axis because of rotation in lensimage
  subplot( 2, 2, iz );
  imagesc( x, x, fliplr( dot( e, e, 3 ) .' ) );
