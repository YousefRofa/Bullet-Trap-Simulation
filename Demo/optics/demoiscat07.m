%  DEMOISCAT07 - Same as demoiscat02.m but with OPD abberation.
...
%  OPD abberation for lens, actual (n,t) and design (nstar,tstar) parameters
n = [ 1.50, 1.492 ];
t = [ 100e3, 170e3 ];
nstar = [ 1.50, 1.49 ];
tstar = [ 100e3, 170e3 ];
...
for iz = 1 : numel( z )
  ...
  focus =  [ 0, 0, z( iz ) ];
  %  image of fields
  isca( :, :, :, iz ) = efield( opd, lens, far,  x, y, 'focus', focus );
  iref( :, :, :, iz ) = efield( opd, lens, refl, x, y, 'focus', focus );
