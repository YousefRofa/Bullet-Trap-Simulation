%  DEMOWEEZER_BULLET - Tweezer simulation for bullet shaped particle.

%  material properties, water and polystyrene
mat1 = Material( 1.33 ^ 2, 1 );
mat2 = Material( 1.59 ^ 2, 1 );
%  long and short radii of the bullet shaped particle
R_ = 150;
L_ = 450;
k0 = 2 * pi / 520;
...
tmat = multipole.tmatbullet( mat2, mat1, R_, L_, k0, 'lmax', 10 );
%  scatterer
fun = @( pos, k0 ) fields( foc, Point( mat1, 1, pos ) );
qinc = multipole.incoming( mat1, k0, fun, 'lmax', tmat.lmax, 'diameter', L_*2 );
scatterer = tweezer.scatterer( tmat, qinc );
%  fluid forces 
fluid = tweezer.fluidellipsoid( R_, L_/R_ );
