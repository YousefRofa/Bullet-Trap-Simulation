...
%
% * Hohenester, <https://link.springer.com/book/10.1007/978-3-030-30504-8
% Nano and Quantum Optics> (Springer 2020).
% * Hohenester, Reichelt, Unger, Nanophotonic resonance modes with the
% nanobem toolbox,
% <https://www.sciencedirect.com/science/article/pii/S0010465522000558 CPC
% 276, 108337 (2022)>;
% <https://www.sciencedirect.com/science/article/pii/S0010465523002941 CPC
% 294, 108949 (2024)>.
%
...
% solver for characteristic modes, a solver for quasistatic eigenmodes, an
% implementation for mesoscopic boundary conditions using Feibelman
% parameters, as well as simulations for stratified media using the
% matrix-friendly approach of Chew.
%
