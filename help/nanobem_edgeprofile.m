...
%   height  -  height of the nanoparticle
%   nz      -  number of z-points used for extrusion
edge = edgeprofile( height, nz, PropertyPairs );
%  user-defined position POS and z-values for edge profile
%    pos  -  list of positions defining the edge
%    z    -  array of z-points used for extrusion
edge = edgeprofile( pos, z, op, PropertyPairs );
