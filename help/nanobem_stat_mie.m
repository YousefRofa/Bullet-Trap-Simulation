%% miestatsolver
%
% Class for the solution of quasistatic Mie theory, see Hohenester, Nano
% and Quantum Optics (Springer 2020), chapter 9.
%
%% Initialization

%  initialize Mie solver
%    mat1       -  material properties at inside of sphere
%    mat2       -  material properties at outside of sphere
%    diameter   -  diameter of sphere in nm 
obj = miestatsolver( mat1, mat2, diameter, PropertyPairs );
